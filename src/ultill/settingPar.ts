...
const setting_par_two: any = {
  ...
  interactivity: {
    ...
    modes: {
      ...
      light: {
        area: {
          gradient: { start: { value: "#000" }, stop: { value: "#000000" } },
          radius: 1000,
        },
        shadow: { color: { value: "#000" }, length: 2000 },
      },
    },
  },
  manualParticles: [],
...
export { settingPar, setting_par_two };
